...
public class Sorting{
    private ArrayList<Student> studentsList1;
    private ArrayList<Student> studentsList2;
    ...
    public void setArray() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            scanner.nextLine();
            studentsList1.add(new Student(firstName, lastName, gpa));
        }
        ...
        for (int i = 0; i < m; i++) {
            ...
            double gpa = scanner.nextDouble();
            scanner.nextLine();
            studentsList2.add(new Student(firstName, lastName, gpa));
        }
